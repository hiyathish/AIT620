...
# ---- helper functions used as model_reporters ----
...
class Simulation(Model):
    ...
    def __init__(self, params, seed=None):
        ...
        self.die_in_hospital_rate = (
            params.get('critical_rate') * hospital_factor / self.hospital_period
        )
    ...
    def set_reporters(self):
        """Configure Mesa DataCollector with model-level reporters."""
        self.datacollector = DataCollector(
            model_reporters={
                ...
                # 'Hospital_capacity': get_hospital_takeup,  # optional
    ...
    def step(self):
        ...
        # update hospital_takeup based on last collected value
        self.hospital_takeup = (
            self.datacollector.model_vars['Hospitalized'][-1] < self.free_beds
        )
